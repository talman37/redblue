...
(
    ...
    COMPANY_REGISTER_UPDATED_AT         DATE     NULL COMMENT '상호변경등기일',
    ...
    COMPANY_ADDRESS_REGISTER_UPDATED_AT DATE     NULL COMMENT '본점주소 변경등기일',
    ...
    HEAD_OFFICE_TRANSFER_REGISTER_AT    DATE     NULL COMMENT '본점전출등기일',
    ...
    LIQUIDATION_REGISTER_AT             DATE     NULL COMMENT '청산등기일',
...
(
    ...
    NO_FACE_VALUE_UPDATED_REGISTER_AT                DATE   NULL COMMENT '무액면 주식의 변경 등기일',
    ...
    NO_FACE_VALUE_CAPITAL_AMOUNT_UPDATED_REGISTER_AT DATE   NULL COMMENT '무액면 주식의 자본전입액 변경등기일',
    PRIMARY KEY (ID)
);
...
(
    ...
    DETAIL_REGISTER_UPDATED_AT DATE   NULL COMMENT '목적사항 변경등기일',
    PRIMARY KEY (ID)
);
...
(
    ...
    REGISTER_UPDATED_AT  DATE   NULL COMMENT '임원 변경 등기일',
